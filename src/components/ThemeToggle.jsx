...
const VAR_SWAP = {
  ...
  /* Orange surface ↔ orange transparent */
  "--brand-neon-cards-surface-light-orange":
    "--brand-neon-cards-surface-light-orange-transparency",
  "--brand-neon-cards-surface-light-orange-transparency":
    "--brand-neon-cards-surface-light-orange",
...
export default function ColorToggle({ targetId = "theme-root", storageKey = "isDarkTheme" }) {
  ...
  const hoverStyle = {
    ...buttonStyle,
    backgroundColor: "var(--brand-neon-cards-surface-light-blue)",
  };
